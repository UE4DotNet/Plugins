...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct BackgroundBlurSlot_fields {
    ...
    internal unsafe struct BackgroundBlurSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(BackgroundBlurSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(BackgroundBlurSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(BackgroundBlurSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct BackgroundBlurSlot_events {
    }
}
