...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct ButtonSlot_fields {
    ...
    internal unsafe struct ButtonSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(ButtonSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(ButtonSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(ButtonSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct ButtonSlot_events {
    }
}
