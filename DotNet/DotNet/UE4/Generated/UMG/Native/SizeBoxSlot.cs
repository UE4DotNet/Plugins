...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct SizeBoxSlot_fields {
    ...
    internal unsafe struct SizeBoxSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(SizeBoxSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(SizeBoxSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(SizeBoxSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct SizeBoxSlot_events {
    }
}
