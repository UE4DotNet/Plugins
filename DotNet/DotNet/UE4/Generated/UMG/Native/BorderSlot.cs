...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct BorderSlot_fields {
    ...
    internal unsafe struct BorderSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(BorderSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(BorderSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(BorderSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct BorderSlot_events {
    }
}
