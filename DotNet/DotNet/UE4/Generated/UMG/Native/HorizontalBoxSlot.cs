...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct HorizontalBoxSlot_fields {
    ...
    internal unsafe struct HorizontalBoxSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(HorizontalBoxSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(HorizontalBoxSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetSize_method {
            ...
            static SetSize_method() {
                SetSize_ptr = Main.GetMethodUFunction(HorizontalBoxSlot.StaticClass, "SetSize");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(HorizontalBoxSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct HorizontalBoxSlot_events {
    }
}
