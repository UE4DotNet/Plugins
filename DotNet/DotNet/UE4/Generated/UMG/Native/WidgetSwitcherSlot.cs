...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct WidgetSwitcherSlot_fields {
    ...
    internal unsafe struct WidgetSwitcherSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(WidgetSwitcherSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(WidgetSwitcherSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(WidgetSwitcherSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct WidgetSwitcherSlot_events {
    }
}
