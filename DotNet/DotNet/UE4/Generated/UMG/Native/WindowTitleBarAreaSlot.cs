...
namespace UE4.UMG.Native {
    ...
    internal unsafe struct WindowTitleBarAreaSlot_fields {
    ...
    internal unsafe struct WindowTitleBarAreaSlot_methods {
        internal struct SetHorizontalAlignment_method {
            ...
            static SetHorizontalAlignment_method() {
                SetHorizontalAlignment_ptr = Main.GetMethodUFunction(WindowTitleBarAreaSlot.StaticClass, "SetHorizontalAlignment");
            }
        ...
        internal struct SetPadding_method {
            ...
            static SetPadding_method() {
                SetPadding_ptr = Main.GetMethodUFunction(WindowTitleBarAreaSlot.StaticClass, "SetPadding");
            }
        ...
        internal struct SetVerticalAlignment_method {
            ...
            static SetVerticalAlignment_method() {
                SetVerticalAlignment_ptr = Main.GetMethodUFunction(WindowTitleBarAreaSlot.StaticClass, "SetVerticalAlignment");
            }
    ...
    internal unsafe struct WindowTitleBarAreaSlot_events {
    }
}
