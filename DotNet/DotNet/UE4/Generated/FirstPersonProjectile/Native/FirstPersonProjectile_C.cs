...
namespace UE4.FirstPersonProjectile.Native {
    ...
    internal unsafe struct FirstPersonProjectile_C_fields {
        [FieldOffset(1024)]  public IntPtr  StaticMesh1;
    }
    internal unsafe struct FirstPersonProjectile_C_methods {
    }
    internal unsafe struct FirstPersonProjectile_C_events {
        ...
        internal unsafe struct UserConstructionScript_event {
            ...
            private static unsafe void UserConstructionScript_process_event(IntPtr context, Frame* theStack, IntPtr result) {
                var obj = UObject.Make<FirstPersonProjectile_C>(context);
