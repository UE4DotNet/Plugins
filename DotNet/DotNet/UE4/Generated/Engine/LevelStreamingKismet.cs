...
namespace UE4.Engine {
    ///<summary>Level Streaming Kismet</summary>
    public unsafe partial class LevelStreamingKismet : LevelStreaming  {
        ...
        ///</remarks>
        public static (bool, LevelStreamingKismet) LoadLevelInstance(UObject WorldContextObject, string LevelName, Vector Location, Rotator Rotation)  => 
            LevelStreamingKismet_methods.LoadLevelInstance_method.Invoke(WorldContextObject, LevelName, Location, Rotation);

        ///<summary>Load Level Instance by Soft Object Ptr</summary>
        public static (bool, LevelStreamingKismet) LoadLevelInstanceBySoftObjectPtr(UObject WorldContextObject, byte Level /*TODO: soft object TSoftObjectPtr<UWorld> */, Vector Location, Rotator Rotation)  => 
            LevelStreamingKismet_methods.LoadLevelInstanceBySoftObjectPtr_method.Invoke(WorldContextObject, Level, Location, Rotation);
        ...
        static LevelStreamingKismet() {
            StaticClass = Main.GetClass("LevelStreamingKismet");
        }
        internal unsafe LevelStreamingKismet_fields* LevelStreamingKismet_ptr => (LevelStreamingKismet_fields*) ObjPointer.ToPointer();

        ///<summary>Convert from IntPtr to UObject</summary>
        public static implicit operator LevelStreamingKismet(IntPtr p) => UObject.Make<LevelStreamingKismet>(p);
        ///<summary>Get UE4 Class</summary>
        public static Class StaticClass {get; private set;}
        ///<summary>Get UE4 Default Object for this Class</summary>
        public static LevelStreamingKismet DefaultObject => Main.GetDefaultObject(StaticClass);
        ///<summary>Spawn an object of this class</summary>
        public static LevelStreamingKismet New(UObject obj = null, Name name = new Name()) => Main.NewObject(StaticClass, obj, name);
    }
}
