...
namespace UE4.Engine.Native {
    ...
    internal unsafe struct SceneCapture2D_fields {
        [FieldOffset(1016)]  public IntPtr  CaptureComponent2D;
        [FieldOffset(1024)]  public IntPtr  DrawFrustum;
    }
    internal unsafe struct SceneCapture2D_methods {
        internal struct OnInterpToggle_method {
            static internal IntPtr OnInterpToggle_ptr;
            static OnInterpToggle_method() {
                OnInterpToggle_ptr = Main.GetMethodUFunction(SceneCapture2D.StaticClass, "OnInterpToggle");
            }
    ...
    internal unsafe struct SceneCapture2D_events {
    }
}
