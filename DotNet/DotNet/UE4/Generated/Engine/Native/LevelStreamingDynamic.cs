...
namespace UE4.Engine.Native {
    ...
    internal unsafe struct LevelStreamingDynamic_fields {
        [FieldOffset(416)] public bool bInitiallyLoaded;
        [FieldOffset(416)] public bool bInitiallyVisible;
    }
    internal unsafe struct LevelStreamingDynamic_methods {
        internal struct LoadLevelInstance_method {
            static internal IntPtr LoadLevelInstance_ptr;
            static LoadLevelInstance_method() {
                LoadLevelInstance_ptr = Main.GetMethodUFunction(LevelStreamingDynamic.StaticClass, "LoadLevelInstance");
            }

            internal static unsafe (bool, LevelStreamingDynamic) Invoke(UObject WorldContextObject, string LevelName, Vector Location, Rotator Rotation) {
                ...
                *((Rotator*)(b+36)) = Rotation;
                Main.GetProcessEvent(LevelStreamingDynamic.DefaultObject, LoadLevelInstance_ptr, new IntPtr(p)); ;
        ...
        internal struct LoadLevelInstanceBySoftObjectPtr_method {
            ...
            static LoadLevelInstanceBySoftObjectPtr_method() {
                LoadLevelInstanceBySoftObjectPtr_ptr = Main.GetMethodUFunction(LevelStreamingDynamic.StaticClass, "LoadLevelInstanceBySoftObjectPtr");
            }

            internal static unsafe (bool, LevelStreamingDynamic) Invoke(UObject WorldContextObject, byte Level /*TODO: soft object TSoftObjectPtr<UWorld> */, Vector Location, Rotator Rotation) {
                ...
                *((Rotator*)(b+68)) = Rotation;
                Main.GetProcessEvent(LevelStreamingDynamic.DefaultObject, LoadLevelInstanceBySoftObjectPtr_ptr, new IntPtr(p)); ;
                 //TODO: soft object TSoftObjectPtr<UWorld> Level
                return (*((bool*)(b+80)),*((IntPtr*)(b+88)));
            }
        }
    }
    internal unsafe struct LevelStreamingDynamic_events {
    }
}
