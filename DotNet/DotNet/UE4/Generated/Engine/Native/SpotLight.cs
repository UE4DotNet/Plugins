...
namespace UE4.Engine.Native {
    ...
    internal unsafe struct SpotLight_fields {
        [FieldOffset(1024)]  public IntPtr  SpotLightComponent;
        [FieldOffset(1032)]  public IntPtr  ArrowComponent;
    }
    internal unsafe struct SpotLight_methods {
        internal struct SetInnerConeAngle_method {
            static internal IntPtr SetInnerConeAngle_ptr;
            static SetInnerConeAngle_method() {
                SetInnerConeAngle_ptr = Main.GetMethodUFunction(SpotLight.StaticClass, "SetInnerConeAngle");
            }
        ...
        internal struct SetOuterConeAngle_method {
            ...
            static SetOuterConeAngle_method() {
                SetOuterConeAngle_ptr = Main.GetMethodUFunction(SpotLight.StaticClass, "SetOuterConeAngle");
            }
    ...
    internal unsafe struct SpotLight_events {
    }
}
