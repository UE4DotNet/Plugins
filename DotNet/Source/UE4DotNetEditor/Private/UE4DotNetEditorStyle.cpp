...
TSharedPtr< FSlateStyleSet > FUE4DotNetEditorStyle::StyleInstance = NULL;

void FUE4DotNetEditorStyle::Initialize()
{
...
void FUE4DotNetEditorStyle::Shutdown()
{
...
FName FUE4DotNetEditorStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("UE4DotNetEditorStyle"));
	return StyleSetName;
}
...
void FUE4DotNetEditorStyle::ReloadTextures()
{
...
const ISlateStyle& FUE4DotNetEditorStyle::Get()
{
